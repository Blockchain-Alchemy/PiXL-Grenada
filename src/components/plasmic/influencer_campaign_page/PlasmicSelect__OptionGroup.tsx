...
import sty from './PlasmicSelect__OptionGroup.module.css'; // plasmic-import: xhYwCOvawVLQzw/css

import SUPER__PlasmicSelect from './PlasmicSelect'; // plasmic-import: cpYU5wUK7lP6LN/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames('__wab_instance', sty.option___6XL6F)}
              />

              <Select__Option
                className={classNames('__wab_instance', sty.option__g5Zsi)}
              />
            </React.Fragment>
          ),
          value: args.children,

...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: tA99duboCCefN-/component
import Select__Option from "../../Select__Option"; // plasmic-import: LTBbkVGBYra5OY/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: cpYU5wUK7lP6LN/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: Xf7EckiSKK-eKU/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: uHyTvaySnM5wDP/icon
          ...
          >
            {(
              ...
              ? p.renderPlasmicSlot({
                  ...
                  value: args.prop,
                  className: classNames(sty.slotTargetProp, {
                    [sty.slotTargetPropcolor_softBlue]: hasVariant(
                      variants,
                      "color",
                      "softBlue"
                    ),
                    [sty.slotTargetPropcolor_softCyan]: hasVariant(
                      variants,
                      "color",
                      "softCyan"
                    ),
                    [sty.slotTargetPropcolor_softGreen]: hasVariant(
                      variants,
                      "color",
                      "softGreen"
                    ),
                    [sty.slotTargetPropcolor_softOrange]: hasVariant(
                      variants,
                      "color",
                      "softOrange"
                    ),
                    [sty.slotTargetPropcolor_softPink]: hasVariant(
                      variants,
                      "color",
                      "softPink"
                    ),
                    [sty.slotTargetPropcolor_softPurple]: hasVariant(
                      variants,
                      "color",
                      "softPurple"
                    ),
                    [sty.slotTargetPropcolor_softRed]: hasVariant(
                      variants,
                      "color",
                      "softRed"
                    ),
                    [sty.slotTargetPropcolor_softYellow]: hasVariant(
                      variants,
                      "color",
                      "softYellow"
                    ),
                    [sty.slotTargetPropisDisabled]: hasVariant(
                      variants,
                      "isDisabled",
                      "isDisabled"
                    ),
                    [sty.slotTargetPropisOpen]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    ),
                    [sty.slotTargetPropshowPlaceholder]: hasVariant(
                      variants,
                      "showPlaceholder",
                      "showPlaceholder"
                    )
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__cyIwO)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__mSkJz)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
